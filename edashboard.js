...
//Make Payment Overlay JS
const makePaymentOverlay = document.getElementById("paymentOverlay");
const paymentOpenBtn = document.getElementById("paymentOpenBtn");
const paymentCloseBtn = document.getElementById("paymentCloseBtn");

//Show Payment open btn
paymentOpenBtn.addEventListener("click", () => {
  makePaymentOverlay.style.display = "flex";
});

//Close Payment btn
paymentCloseBtn.addEventListener("click", () => {
  makePaymentOverlay.style.display = "none";
});

//Close Overlay when user click outside content
makePaymentOverlay.addEventListener("click", (e) => {
  if (e.target === makePaymentOverlay) {
    makePaymentOverlay.style.display = "none";
  }
});
